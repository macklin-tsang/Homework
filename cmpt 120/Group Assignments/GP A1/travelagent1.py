...
# If they are interested in creating an account, the program will appreciate the user for working with it and call the password function, then say Goodbye.
elif account =="y":
