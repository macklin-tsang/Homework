...
# For looking up the months in the list: Grab the first string (which is the month in number form), convert it into an integer, and use that key number to look up the month in the months list.
...
# For example, if the input month integer is 1 (January), it will subtract that integer by 1, resulting in 0. This will print January which is technically "#0" position in the list, but is the first month of the year.
